<h1>Edit Template </h1>
<form method="post" accept-charset="utf-8" action="<?php echo ($base_url . 'template/edit_template/' . $template_id); ?>" name="form" id="form" />

<?php
    $edit_template_code = array(
		'name' => 'edit_template_code',
		'id' => 'edit_template_code', 
		'value' => set_value('edit_template_code', $code)
	);
    
    $edit_template_discrete = array(
		'name' => 'edit_template_discrete',
		'id' => 'edit_template_discrete', 
		'value' => set_value('edit_template_discrete', $details[0]['discrete_inputs'])
	);
    
    $edit_template_continuous = array(
		'name' => 'edit_template_continuous',
		'id' => 'edit_template_continuous', 
		'value' => set_value('edit_template_continuous', $details[0]['continuous_inputs'])
	);
    ...
    $edit_template_notes = array(
		...
		'value' => set_value('edit_template_notes', $details[0]['notes'])
	);
...
<?php if($processing_code != ""){ echo $processing_code; ?> <a id="canvas_help" ><canvas id="processing-canvas"></canvas></a> <?php } else { echo "<img src='" . $base_url . 'template_images/' .  $template_id . ".png' />"; } ?>
...
<?php echo form_dropdown('edit_template_type', $edit_template_type_options, set_value('edit_template_type', $details[0]['type']), 'id="edit_template_type"'); ?>
