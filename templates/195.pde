...
float ball_multiplier = (col_width * 2) / largest2;
float hor_counter = 0;
color temp;
int col_count = 0;
...
fill(255);
ellipse(100 + hor_counter + col_width  / 2, data[b][1] * vert_multiplier, col_width * 2, col_width * 2);
fill(0);
ellipse(100 + hor_counter + col_width  / 2, data[b][1] * vert_multiplier, col_width * 2 - 2, col_width * 2 - 2);
fill(255);
//temp_diam = ((col_width * 3 - 2) / 100) * data[b][2];
ellipse(100 + hor_counter + col_width  / 2, data[b][1] * vert_multiplier,data[b][2] * ball_multiplier, data[b][2] * ball_multiplier );
...
rotate(PI / 2);
translate(0, -height);
text(data[b][0], 660 + 10, 900 - hor_counter - col_width / 2);
translate(0, height);
rotate(-PI / 2);
hor_counter +=  col_width ;
}
