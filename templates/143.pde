...
{
ellipse(100 + column_width_with_space * (a -1) - column_width_with_space / 2, 850 - height_counter + column_width_with_space / 2, 100 + column_width_with_space * (a -1) + column_width * 3 / 2, 850 - height_counter - column_width * 3 / 2);
...
translate(0, -height);
fill(0);
text(data[a][0] , 860 + column_width_with_space / 2, 900 - (column_width_with_space / 2 + column_width_with_space * (a - 1)));
translate(0, height);
rotate(-PI/2);
}
