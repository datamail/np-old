...
int multiplier = (600 / (num_rings / 10)  );
...
noStroke();
 arc(500, 500, data[c][1] / total * multiplier, data[c][1] / total * multiplier, -PI/2 + (c - 1) * slice_size, -PI/2 + (c) * slice_size);
fill(255);
ellipse((cos( -PI/2 + (c - 0.5) * slice_size) *data[c][1] / total * multiplier) * 0.45 + width / 2 , (sin( -PI/2 + (c - 0.5) * slice_size) *data[c][1] / total * multiplier) * 0.45 + width / 2, 5, 5);
stroke(255);
line((cos( -PI/2 + (c - 0.5) * slice_size) *data[c][1] / total * multiplier) * 0.45 + width / 2 , (sin( -PI/2 + (c - 0.5) * slice_size) *data[c][1] / total * multiplier) * 0.45 + width / 2,(cos( -PI/2 + (c - 0.5) * slice_size) * 750) * 0.45 + width / 2 , (sin( -PI/2 + (c - 0.5) * slice_size) * 750) * 0.45 + width / 2);
font_size = 40;
textFont(myFont, font_size);
