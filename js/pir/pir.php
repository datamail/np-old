...
$font_folder = "C://xampp/htdocs/avisual/fonts/";
...
$cache_folder = 'cache' ;
$textcase = isset($_GET['casing']) ? $_GET['casing'] : '' ;
...
$hash = md5(basename($font_file) . $font_size . $font_color . $text);
...
$background_color = ImageColorAllocateAlpha($image,255,255,255,127); //fully transparent
